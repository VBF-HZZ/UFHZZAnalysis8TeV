...
// To store array of TLorentzVector
...
private:
    ...
    MEMs *MEMsnoPDFs_2e2mu;
    MEMs *MEMsnoPDFs_2mu2e;  

    MEKD *MEKDnoPDFs;

    double leptonIntWeight;
    ...
    double JHUKD_H_h2hP_prodInd_noPDF, JHU_ME_h2hP_prodInd;
    double JHUKD_H_h2hM_prodInd_noPDF, JHU_ME_h2hM_prodInd;
    double JHUKD_H_h2bP_prodInd_noPDF, JHU_ME_h2bP_prodInd;
    double JHUKD_H_qqh2hP_noPDF, JHU_ME_qqh2hP;
    double JHUKD_H_qqh2hM_noPDF, JHU_ME_qqh2hM;
    double JHUKD_H_qqh2bP_noPDF, JHU_ME_qqh2bP;

    double JHUKD_H_ggZZ_noPDF, MCFM_ME_ggZZ;

    double JHUKD_H_h2h2P_prodInd_noPDF, JHU_ME_h2h2P_prodInd;
    double JHUKD_H_h2h3P_prodInd_noPDF, JHU_ME_h2h3P_prodInd;
    double JHUKD_H_h2h6P_prodInd_noPDF, JHU_ME_h2h6P_prodInd;
    double JHUKD_H_h2h7P_prodInd_noPDF, JHU_ME_h2h7P_prodInd;
    double JHUKD_H_h2h9M_prodInd_noPDF, JHU_ME_h2h9M_prodInd;
    double JHUKD_H_h2h10M_prodInd_noPDF,JHU_ME_h2h10M_prodInd;

    double JHUKD_H_ggh2h2P_noPDF, JHU_ME_ggh2h2P;
    double JHUKD_H_ggh2h3P_noPDF, JHU_ME_ggh2h3P;
    double JHUKD_H_ggh2h6P_noPDF, JHU_ME_ggh2h6P;
    double JHUKD_H_ggh2h7P_noPDF, JHU_ME_ggh2h7P;
    double JHUKD_H_ggh2h9M_noPDF, JHU_ME_ggh2h9M;
    double JHUKD_H_ggh2h10M_noPDF,JHU_ME_ggh2h10M;

    double JHUKD_H_qqh2h2P_noPDF, JHU_ME_qqh2h2P;
    double JHUKD_H_qqh2h3P_noPDF, JHU_ME_qqh2h3P;
    double JHUKD_H_qqh2h6P_noPDF, JHU_ME_qqh2h6P;
    double JHUKD_H_qqh2h7P_noPDF, JHU_ME_qqh2h7P;
    double JHUKD_H_qqh2h9M_noPDF, JHU_ME_qqh2h9M;
    double JHUKD_H_qqh2h10M_noPDF,JHU_ME_qqh2h10M;

    double JHU_ME_H_prodIndep;
    double MCFM_ME_qqZZ_prodIndep;
    double JHUKD_H_qqZZ_prodIndep_noPDF;
    ...
    double ME_H, ME_PH, ME_PS, ME_X13_int, ME_X12_int, ME_X23_int, ME_X13_int_kg1g4, ME_X12_int_kg1g2, ME_X23_int_kg2g4, ME_Xmix13_60, ME_Xmix12_60, ME_Xmix23_60;
    ...
    double MEKD_ME_H_noPDF_2e2mu, MEKD_ME_H_noPDF_2mu2e;
    ...
    bool mZ1_mZ2(TClonesArray *v4L, vector<int> idL, unsigned int& L1, unsigned int& L2, unsigned int& L3, unsigned int& L4);
    ...
    int MomMomID_L1, MomMomID_L2, MomMomID_L3, MomMomID_L4;
    int GenFS, RecoFS;
    ...
    //GEN
    vector<int> GENidLS1; vector<int> GENchargeLS1; vector<bool> GENisfromHLS1; vector<int> GENmomIdLS1;
    vector<double> GENisoLS1;
    TClonesArray *GENp4LS1;

    int Z1daughtersId, Z2daughtersId;
    int Z1momId, Z2momId;
    int nGenZs;
    TLorentzVector GENp4Z1, GENp4Z2;

    vector<int> GENidLS3; vector<int> GENchargeLS3; vector<bool> GENisfromHLS3; vector<bool> GENisfromWLS3; vector<int> GENmomIdLS3;
    vector<double> GENisoLS3; vector<double> GENchargedisoLS3; vector<double> GENneutralisoLS3; 
    TClonesArray *GENp4LS3;

    double GENmZ1Z2;

    int GENlepIndex1, GENlepIndex2, GENlepIndex3, GENlepIndex4;

    vector<double> GENrecoIso, GENrecoIsoCharged, GENrecoIsoNeutral;
    ...
    TClonesArray *genJetP4_dR;
    TClonesArray *selectedJetP4;
    ...
    //------------------------------------------------------------------------------------------------------------
    // Help functions for anomalous couplings...
    // ... this work only to return intreference term for pair of operators
    double computeInterferenceTermKappas(double k1, double k2, double k3, double ME_H, double ME_PH, double ME_PS, double ME_X){
        double s_gamma11 = 1;
        double s_gamma22 = 1;
        double s_gamma33 = 1;
        double interference = (ME_X - k1*k1*s_gamma11*ME_H - k2*k2*s_gamma22*ME_PH - k3*k3*s_gamma33*ME_PS)/(k1*k3+k1*k2+k2*k3);
        return interference;
    }

    double computeInterferenceTerm13(double angle, double ME_A, double ME_B, double ME_X){
        double k1 = cos(angle);
        double k3 = sin(angle);
        return computeInterferenceTermKappas(k1, 0, k3, ME_A, 0, ME_B, ME_X);
    }

    double computeInterferenceTerm12(double angle, double ME_A, double ME_B, double ME_X){
        double k1 = cos(angle);
        double k2 = sin(angle);
        return computeInterferenceTermKappas(k1, k2, 0, ME_A, ME_B, 0, ME_X);
    }

    double computeInterferenceTerm23(double angle, double ME_A, double ME_B, double ME_X){
        double k2 = cos(angle);
        double k3 = sin(angle);
        double interference = computeInterferenceTermKappas(0, k2, k3, 0, ME_A, ME_B, ME_X);
        return interference;
    }
    double computeME_X(double k1, double k2, double k3, double ME_H, double ME_PH, double ME_PS, double ME_13, double ME_12, double ME_23){
        double ME_X = k1*k1*ME_H + k2*k2*ME_PH + k3*k3*ME_PS + (k1*k3)*ME_13 + (k1*k2)*ME_12 + (k2*k3)*ME_23;
        return ME_X;
    }
    //------------------------------------------------------------------------------------------------------------
    ...
    bStudyFourLeptonResolution(iConfig.getUntrackedParameter<bool>("bStudyFourLeptonResolution",false))
{
    ...
    MomMomID_L1 = 99999; MomMomID_L2= 99999; MomMomID_L3 = 99999; MomMomID_L4 = 99999;
    ...
    //  MEMsnoPDFs_noFSR = new MEMs(8,125.6);
    MEMsnoPDFs = new MEMs(8,mH,"",false,false);

    MEMsnoPDFs_2e2mu = new MEMs(8,mH,"",false,false);
    MEMsnoPDFs_2mu2e = new MEMs(8,mH,"",false,false);
...
UFHZZ4LAna::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    ...
    //std::cout<<runId<<":"<<eventId<<":"<<lumiId<<std::endl;
    ...
    Z1daughtersId=9999; Z2daughtersId=9999;
    Z1momId=9999; Z2momId=9999;
    nGenZs = 0;
    GENmZ1Z2 = 0;

    GENlepIndex1=-1; GENlepIndex2=-1; GENlepIndex3=-1; GENlepIndex4=-1;
    ...
    JHUKD_H_h2hP_prodInd_noPDF = -999; JHU_ME_h2hP_prodInd = -999;
    JHUKD_H_h2hM_prodInd_noPDF = -999; JHU_ME_h2hM_prodInd = -999;
    JHUKD_H_h2bP_prodInd_noPDF = -999; JHU_ME_h2bP_prodInd = -999;
    JHUKD_H_qqh2hP_noPDF = -999; JHU_ME_qqh2hP = -999;
    JHUKD_H_qqh2hM_noPDF = -999; JHU_ME_qqh2hM = -999;
    JHUKD_H_qqh2bP_noPDF = -999; JHU_ME_qqh2bP = -999;

    JHUKD_H_qqZZ_prodIndep_noPDF = -999;MCFM_ME_qqZZ_prodIndep = -999;
    JHUKD_H_ggZZ_noPDF = -999; MCFM_ME_ggZZ = -999;
    JHU_ME_H_prodIndep = -999;

    JHUKD_H_h2h2P_prodInd_noPDF = -999; JHU_ME_h2h2P_prodInd = -999;
    JHUKD_H_h2h3P_prodInd_noPDF = -999; JHU_ME_h2h3P_prodInd = -999;
    JHUKD_H_h2h6P_prodInd_noPDF = -999; JHU_ME_h2h6P_prodInd = -999;
    JHUKD_H_h2h7P_prodInd_noPDF = -999; JHU_ME_h2h7P_prodInd = -999;
    JHUKD_H_h2h9M_prodInd_noPDF = -999; JHU_ME_h2h9M_prodInd = -999;
    JHUKD_H_h2h10M_prodInd_noPDF = -999; JHU_ME_h2h10M_prodInd = -999;

    JHUKD_H_ggh2h2P_noPDF = -999; JHU_ME_ggh2h2P = -999;
    JHUKD_H_ggh2h3P_noPDF = -999; JHU_ME_ggh2h3P = -999;
    JHUKD_H_ggh2h6P_noPDF = -999; JHU_ME_ggh2h6P = -999;
    JHUKD_H_ggh2h7P_noPDF = -999; JHU_ME_ggh2h7P = -999;
    JHUKD_H_ggh2h9M_noPDF = -999; JHU_ME_ggh2h9M = -999;
    JHUKD_H_ggh2h10M_noPDF = -999; JHU_ME_ggh2h10M = -999;

    JHUKD_H_qqh2h2P_noPDF = -999; JHU_ME_qqh2h2P = -999;
    JHUKD_H_qqh2h3P_noPDF = -999; JHU_ME_qqh2h3P = -999;
    JHUKD_H_qqh2h6P_noPDF = -999; JHU_ME_qqh2h6P = -999;
    JHUKD_H_qqh2h7P_noPDF = -999; JHU_ME_qqh2h7P = -999;
    JHUKD_H_qqh2h9M_noPDF = -999; JHU_ME_qqh2h9M = -999;
    JHUKD_H_qqh2h10M_noPDF = -999; JHU_ME_qqh2h10M = -999;
    ...
    ME_H  = -999; ME_PH = -999; ME_PS = -999; ME_X13_int = -999; ME_X12_int = -999; ME_X23_int = -999;
    ME_X13_int_kg1g4  = -999; ME_X12_int_kg1g2  = -999; ME_X23_int_kg2g4  = -999;
    ME_Xmix13_60  = -999; ME_Xmix12_60  = -999; ME_Xmix23_60  = -999;
    ...
    MEKD_ME_H_noPDF_2e2mu = -999; MEKD_ME_H_noPDF_2mu2e = -999;
    minDeltR = 1000;
    leastIso = 0;
    highestSip = 0;
    theta12 = 1000;
    ...
    passedFiducialKinematics=false;
    passedFiducialTopology=false;
    //if(isMC && isSignal)
    if(isMC)
    {

        genAna.fillGenEvent(genParticles,Higgs,Zs,leptonsS1,leptonsS3,isFromH,isFromW);
        setGENVariables(Higgs,Zs,genParticles,genJets,leptonsS1,leptonsS3,isFromH,isFromW);
    ...
    if( notDuplicateEvent && !vertex->empty()) {
        ...
        if (leptonsS3.size()>=4) {
            ...
            GENrecoIso.clear(); GENrecoIsoCharged.clear(); GENrecoIsoNeutral.clear();
            ...
            for(unsigned int i = 0; i<leptonsS3.size(); i++){
                ...
                for(unsigned int j = 0; j<recoMuons.size(); j++){
                    ...
                    if(recoMuons[j].pdgId()==leptonsS3[i].pdgId()){
                        ...
                        if(dR_temp<dR){ 
                            GENrecoIso.push_back(helper.pfIso(recoMuons[j],muonRho));  
                            GENrecoIsoCharged.push_back(helper.pfIso(recoMuons[j],muonRho));
                            GENrecoIsoNeutral.push_back(helper.pfIso(recoMuons[j],muonRho));
                        }
                    }
                } // reco muons
                ...
                for(unsigned int j = 0; j<recoElectrons.size(); j++){
                    ...
                    if(recoElectrons[j].pdgId()==leptonsS3[i].pdgId()){
                        ...
                        if(dR_temp<dR){
                            GENrecoIso.push_back(helper.pfIso(recoElectrons[j],elecRho));
                            GENrecoIsoCharged.push_back(helper.pfIso(recoElectrons[j],elecRho));
                            GENrecoIsoNeutral.push_back(helper.pfIso(recoElectrons[j],elecRho));
                        }
                    }
                } // reco electrons
                
            } // status 3 leptons
        } // at least 4 status 3 leptons
                        ...
                        if( passedPtCuts ){
                            ...
                            if(fourLep_Cleaned){
                                ...
                                */
                                ...
                                vector<int> tmpIDs_2e2mu, tmpIDs_2mu2e;
                                tmpIDs_2e2mu.push_back(11);  tmpIDs_2mu2e.push_back(13);
                                tmpIDs_2e2mu.push_back(-11); tmpIDs_2mu2e.push_back(-13);
                                tmpIDs_2e2mu.push_back(13);  tmpIDs_2mu2e.push_back(11);
                                tmpIDs_2e2mu.push_back(-13); tmpIDs_2mu2e.push_back(-11);

                                //double dummy, dummy2;
                                //MEMsnoPDFs_2e2mu->computeMEs(P4s,tmpIDs_2e2mu);
                                //MEMsnoPDFs_2e2mu->computeKD(kSMHiggs,kMEKD, kqqZZ, kMEKD, &MEMs::probRatio, dummy, MEKD_ME_H_noPDF_2e2mu, dummy2);
                                //MEMsnoPDFs_2mu2e->computeMEs(P4s,tmpIDs_2mu2e);
                                //MEMsnoPDFs_2mu2e->computeKD(kSMHiggs,kMEKD, kqqZZ, kMEKD, &MEMs::probRatio, dummy, MEKD_ME_H_noPDF_2mu2e, dummy2);

                                MEMsnoPDFs->computeME(kSMHiggs, kMEKD, P4s,tmpIDs, MEKD_ME_H_noPDF);
                                MEMsnoPDFs->computeME(kSMHiggs, kMEKD, P4s,tmpIDs_2e2mu, MEKD_ME_H_noPDF_2e2mu);
                                MEMsnoPDFs->computeME(kSMHiggs, kMEKD, P4s,tmpIDs_2mu2e, MEKD_ME_H_noPDF_2mu2e);
                                leptonIntWeight = MEKD_ME_H_noPDF/(0.5*(MEKD_ME_H_noPDF_2e2mu+MEKD_ME_H_noPDF_2mu2e));

                                // compute with MEM, with FSR
                                ...
                                //MEMsnoPDFs->computeKD(kSMHiggs, kJHUGen, k2mplus_prodIndep, kJHUGen, &MEMs::probRatio, JHUKD_H_h2P_prodInd_noPDF, JHU_ME_H, JHU_ME_h2P_prodInd);
                                //MEMsnoPDFs->computeKD(kSMHiggs, kJHUGen, k1plus_prodIndep,  kJHUGen, &MEMs::probRatio, JHUKD_H_h1P_prodInd_noPDF, JHU_ME_H, JHU_ME_h1P_prodInd);
                                //MEMsnoPDFs->computeKD(kSMHiggs, kJHUGen, k1minus_prodIndep, kJHUGen, &MEMs::probRatio, JHUKD_H_h1M_prodInd_noPDF, JHU_ME_H, JHU_ME_h1M_prodInd);
                                //
                                //// compute with MEM, no FSR
                                ...
                                //
                                //MEMsnoPDFs_noFSR->computeKD(k2hplus, kMEKD, kqqZZ,  kMEKD, &MEMs::probRatio, MEKD_h2hP_ZZ_noPDF_noFSR, MEKD_ME_h2hP_noPDF_noFSR, MEKD_ME_ZZ_noPDF_noFSR);
                                //MEMsnoPDFs_noFSR->computeKD(k2hminus, kMEKD, kqqZZ, kMEKD, &MEMs::probRatio, MEKD_h2hM_ZZ_noPDF_noFSR, MEKD_ME_h2hM_noPDF_noFSR, MEKD_ME_ZZ_noPDF_noFSR);
                                //MEMsnoPDFs_noFSR->computeKD(k2bplus, kMEKD, kqqZZ,  kMEKD, &MEMs::probRatio, MEKD_h2bP_ZZ_noPDF_noFSR, MEKD_ME_h2bP_noPDF_noFSR, MEKD_ME_ZZ_noPDF_noFSR);
                                //MEMsnoPDFs_noFSR->computeKD(k2mplus_prodIndep, kMEKD, kqqZZ, kMEKD, &MEMs::probRatio, MEKD_h2P_ZZ_prodInd_noPDF_noFSR, MEKD_ME_h2P_prodInd_noPDF_noFSR, MEKD_ME_ZZ_noPDF_noFSR);
                                //MEMsnoPDFs_noFSR->computeKD(k1plus_prodIndep, kMEKD, kqqZZ,  kMEKD, &MEMs::probRatio, MEKD_h1P_ZZ_prodInd_noPDF_noFSR, MEKD_ME_h1P_prodInd_noPDF_noFSR, MEKD_ME_ZZ_noPDF_noFSR);
                                //MEMsnoPDFs_noFSR->computeKD(k1minus_prodIndep, kMEKD, kqqZZ, kMEKD, &MEMs::probRatio, MEKD_h1M_ZZ_prodInd_noPDF_noFSR, MEKD_ME_h1M_prodInd_noPDF_noFSR, MEKD_ME_ZZ_noPDF_noFSR);
                                ...
                                /*
                                //--------------------------------SM-----------------------------------//
                                MEMsnoPDFs->computeME(kSMHiggs,           kJHUGen, P4s,tmpIDs, JHU_ME_H);
                                MEMsnoPDFs->computeME(kSMHiggs_prodIndep, kJHUGen, P4s,tmpIDs, JHU_ME_H_prodIndep);
                                //--------------------------------SM-----------------------------------//

                                //-------------------------------------------------------------------//
                                // compute with MEM, with FSR, non-spin-0 MEs
                                //-------------------------------------------------------------------//

                                MEMsnoPDFs->computeME(k1minus,          kJHUGen, P4s,tmpIDs, JHU_ME_h1M);         JHUKD_H_h1M_noPDF   = 1/( 1 + JHU_ME_h1M/JHU_ME_H);
                                MEMsnoPDFs->computeME(k1plus,           kJHUGen, P4s,tmpIDs, JHU_ME_h1P);         JHUKD_H_h1P_noPDF   = 1/( 1 + JHU_ME_h1P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k1plus_prodIndep, kJHUGen, P4s,tmpIDs, JHU_ME_h1P_prodInd); JHUKD_H_h1P_prodInd_noPDF   = 1/( 1 + JHU_ME_h1P_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k1minus_prodIndep,kJHUGen, P4s,tmpIDs, JHU_ME_h1M_prodInd); JHUKD_H_h1M_prodInd_noPDF   = 1/( 1 + JHU_ME_h1M_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2mplus_gg,       kJHUGen, P4s,tmpIDs, JHU_ME_ggh2P);       JHUKD_H_ggh2P_noPDF = 1/( 1 + JHU_ME_ggh2P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2mplus_qqbar,    kJHUGen, P4s,tmpIDs, JHU_ME_qqh2P);       JHUKD_H_qqh2P_noPDF = 1/( 1 + JHU_ME_qqh2P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2mplus_prodIndep,kJHUGen, P4s,tmpIDs, JHU_ME_h2P_prodInd); JHUKD_H_h2P_prodInd_noPDF   = 1/( 1 + JHU_ME_h2P_prodInd/JHU_ME_H);

                                MEMsnoPDFs->computeME(k2hplus,      kJHUGen, P4s,tmpIDs, JHU_ME_h2hP);     JHUKD_H_h2hP_noPDF   = 1/( 1 + JHU_ME_h2hP/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2hminus,     kJHUGen, P4s,tmpIDs, JHU_ME_h2hM);     JHUKD_H_h2hM_noPDF   = 1/( 1 + JHU_ME_h2hM/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2bplus,      kJHUGen, P4s,tmpIDs, JHU_ME_h2bP);     JHUKD_H_h2bP_noPDF   = 1/( 1 + JHU_ME_h2bP/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h2plus_gg,  kJHUGen, P4s,tmpIDs, JHU_ME_ggh2h2P);  JHUKD_H_ggh2h2P_noPDF = 1/( 1 +  JHU_ME_ggh2h2P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h3plus_gg,  kJHUGen, P4s,tmpIDs, JHU_ME_ggh2h3P);  JHUKD_H_ggh2h3P_noPDF = 1/( 1 +  JHU_ME_ggh2h3P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h6plus_gg,  kJHUGen, P4s,tmpIDs, JHU_ME_ggh2h6P);  JHUKD_H_ggh2h6P_noPDF = 1/( 1 +  JHU_ME_ggh2h6P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h7plus_gg,  kJHUGen, P4s,tmpIDs, JHU_ME_ggh2h7P);  JHUKD_H_ggh2h7P_noPDF = 1/( 1 +  JHU_ME_ggh2h7P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h9minus_gg, kJHUGen, P4s,tmpIDs, JHU_ME_ggh2h9M);  JHUKD_H_ggh2h9M_noPDF = 1/( 1 +  JHU_ME_ggh2h9M/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h10minus_gg,kJHUGen, P4s,tmpIDs, JHU_ME_ggh2h10M); JHUKD_H_ggh2h10M_noPDF = 1/( 1 + JHU_ME_ggh2h10M/JHU_ME_H);

                                MEMsnoPDFs->computeME(k2hplus_qqbar,   kJHUGen, P4s,tmpIDs, JHU_ME_qqh2hP);   JHUKD_H_qqh2hP_noPDF   = 1/( 1 + JHU_ME_qqh2hP/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2hminus_qqbar,  kJHUGen, P4s,tmpIDs, JHU_ME_qqh2hM);   JHUKD_H_qqh2hM_noPDF   = 1/( 1 + JHU_ME_qqh2hM/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2bplus_qqbar,   kJHUGen, P4s,tmpIDs, JHU_ME_qqh2bP);   JHUKD_H_qqh2bP_noPDF   = 1/( 1 + JHU_ME_qqh2bP/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h2plus_qqbar,  kJHUGen, P4s,tmpIDs, JHU_ME_qqh2h2P);  JHUKD_H_qqh2h2P_noPDF = 1/( 1 +  JHU_ME_qqh2h2P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h3plus_qqbar,  kJHUGen, P4s,tmpIDs, JHU_ME_qqh2h3P);  JHUKD_H_qqh2h3P_noPDF = 1/( 1 +  JHU_ME_qqh2h3P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h6plus_qqbar,  kJHUGen, P4s,tmpIDs, JHU_ME_qqh2h6P);  JHUKD_H_qqh2h6P_noPDF = 1/( 1 +  JHU_ME_qqh2h6P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h7plus_qqbar,  kJHUGen, P4s,tmpIDs, JHU_ME_qqh2h7P);  JHUKD_H_qqh2h7P_noPDF = 1/( 1 +  JHU_ME_qqh2h7P/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h9minus_qqbar, kJHUGen, P4s,tmpIDs, JHU_ME_qqh2h9M);  JHUKD_H_qqh2h9M_noPDF = 1/( 1 +  JHU_ME_qqh2h9M/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h10minus_qqbar,kJHUGen, P4s,tmpIDs, JHU_ME_qqh2h10M); JHUKD_H_qqh2h10M_noPDF = 1/( 1 + JHU_ME_qqh2h10M/JHU_ME_H);

                                MEMsnoPDFs->computeME(k2hplus_prodIndep,   kJHUGen, P4s,tmpIDs, JHU_ME_h2hP_prodInd); JHUKD_H_h2hP_prodInd_noPDF   = 1/( 1 + JHU_ME_h2hP_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2hminus_prodIndep,  kJHUGen, P4s,tmpIDs, JHU_ME_h2hM_prodInd); JHUKD_H_h2hM_prodInd_noPDF   = 1/( 1 + JHU_ME_h2hM_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2bplus_prodIndep,   kJHUGen, P4s,tmpIDs, JHU_ME_h2bP_prodInd); JHUKD_H_h2bP_prodInd_noPDF   = 1/( 1 + JHU_ME_h2bP_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h2plus_prodIndep,  kJHUGen, P4s,tmpIDs, JHU_ME_h2h2P_prodInd);  JHUKD_H_h2h2P_prodInd_noPDF = 1/( 1 +  JHU_ME_h2h2P_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h3plus_prodIndep,  kJHUGen, P4s,tmpIDs, JHU_ME_h2h3P_prodInd);  JHUKD_H_h2h3P_prodInd_noPDF = 1/( 1 +  JHU_ME_h2h3P_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h6plus_prodIndep,  kJHUGen, P4s,tmpIDs, JHU_ME_h2h6P_prodInd);  JHUKD_H_h2h6P_prodInd_noPDF = 1/( 1 +  JHU_ME_h2h6P_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h7plus_prodIndep,  kJHUGen, P4s,tmpIDs, JHU_ME_h2h7P_prodInd);  JHUKD_H_h2h7P_prodInd_noPDF = 1/( 1 +  JHU_ME_h2h7P_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h9minus_prodIndep, kJHUGen, P4s,tmpIDs, JHU_ME_h2h9M_prodInd);  JHUKD_H_h2h9M_prodInd_noPDF = 1/( 1 +  JHU_ME_h2h9M_prodInd/JHU_ME_H);
                                MEMsnoPDFs->computeME(k2h10minus_prodIndep,kJHUGen, P4s,tmpIDs, JHU_ME_h2h10M_prodInd); JHUKD_H_h2h10M_prodInd_noPDF = 1/( 1 + JHU_ME_h2h10M_prodInd/JHU_ME_H);


                                //-------------------------------------------------------------------//
                                // compute with MEM, with FSR, spin-0 mixing for anomalous couplings
                                //-------------------------------------------------------------------//
                                // -------- JHUGen - like -------- //
                                MEMsnoPDFs->computeME(k0minus, kJHUGen, P4s,tmpIDs,   JHU_ME_h0M);  JHUKD_H_h0M_noPDF = 1/( 1 +   JHU_ME_h0M/JHU_ME_H);
                                MEMsnoPDFs->computeME(k0hplus, kJHUGen, P4s,tmpIDs,   JHU_ME_h0P);  JHUKD_H_h0P_noPDF = 1/( 1 +   JHU_ME_h0P/JHU_ME_H);
                                MEMsnoPDFs->computeME(kqqZZ,   kMCFM,   P4s,tmpIDs, MCFM_ME_qqZZ); JHUKD_H_qqZZ_noPDF = 1/( 1 + MCFM_ME_qqZZ/JHU_ME_H);
                                MEMsnoPDFs->computeME(kqqZZ_prodIndep,   kMCFM,   P4s,tmpIDs, MCFM_ME_qqZZ_prodIndep); JHUKD_H_qqZZ_prodIndep_noPDF = 1/( 1 + MCFM_ME_qqZZ_prodIndep/JHU_ME_H);
                                MEMsnoPDFs->computeME(kggZZ,   kMCFM,   P4s,tmpIDs, MCFM_ME_ggZZ); JHUKD_H_ggZZ_noPDF = 1/( 1 + MCFM_ME_ggZZ/JHU_ME_H);

                                // these are actually some Ps, not really the MEs
                                MEMsnoPDFs->computeME_Interference(kg1g4,kJHUGen,P4s,tmpIDs,ME_X13_int_kg1g4);
                                MEMsnoPDFs->computeME_Interference(kg1g2,kJHUGen,P4s,tmpIDs,ME_X12_int_kg1g2);
                                // -------- MEKD - like -------- //

                                double angle; // mixing angle
                                double ME_Xmix13_45, ME_Xmix12_45, ME_Xmix23_45, ME_H_ph, ME_X13_int_from60; // auxilary MEs

                                // production couplings - SM-like
                                vector<complex<double> >* prod = new vector<complex<double> >;

                                angle = 0. * PI/180.;
                                // SM-like (ps)
                                vector<complex<double> >* dCouplings_sm = new vector<complex<double> >;
                                dCouplings_sm->push_back(cos(angle));
                                dCouplings_sm->push_back(0);
                                dCouplings_sm->push_back(0);
                                dCouplings_sm->push_back(sin(angle));
                                //MEMsnoPDFs->Convert_couplings_kappa_to_a(kSpin0_gg, prod, dCouplings_sm, prod, dCouplings_sm);
                                MEMsnoPDFs->computeME(kSpin0_gg,kJHUGen,P4s, tmpIDs, prod, dCouplings_sm, ME_H);
                                //cout << "angle: " << angle << endl;
                                //cout << "  dCouplings_sm[0]: " << (*dCouplings_sm)[0] << ", dCouplings_sm[1]: " << (*dCouplings_sm)[1]
                                //<< ", dCouplings_sm[2]: " << (*dCouplings_sm)[2] << ", dCouplings_sm[3]: " << (*dCouplings_sm)[3] << endl;

                                angle = 90 * PI/180.;
                                // 0M-like
                                vector<complex<double> >* dCouplings_ps = new vector<complex<double> >;
                                dCouplings_ps->push_back(cos(angle)); //g1-term
                                dCouplings_ps->push_back(0);          //g2-term
                                dCouplings_ps->push_back(0);          //g3-term
                                dCouplings_ps->push_back(sin(angle)); //g4-term
                                MEMsnoPDFs->computeME(kSpin0_gg, kJHUGen, P4s, tmpIDs, prod, dCouplings_ps, ME_PS);
                                // 0Ph-like
                                vector<complex<double> >* dCouplings_ph = new vector<complex<double> >;
                                dCouplings_ph->push_back(cos(angle)); //g1-term
                                dCouplings_ph->push_back(sin(angle)); //g2-term
                                dCouplings_ph->push_back(0);          //g3-term
                                dCouplings_ph->push_back(0);          //g4-term
                                MEMsnoPDFs->computeME(kSpin0_gg, kJHUGen, P4s, tmpIDs, prod, dCouplings_ph, ME_PH);

                                angle = 45 * PI/180.;
                                // mixed H-0M (1,3)
                                vector<complex<double> >* dCouplings_mix13_45 = new vector<complex<double> >;
                                dCouplings_mix13_45->push_back(cos(angle)); //g1-term
                                dCouplings_mix13_45->push_back(0);          //g2-term
                                dCouplings_mix13_45->push_back(0);          //g3-term
                                dCouplings_mix13_45->push_back(sin(angle)); //g4-term
                                MEMsnoPDFs->computeME(kSpin0_gg, kJHUGen, P4s, tmpIDs, prod, dCouplings_mix13_45, ME_Xmix13_45);
                                // mixed H-0Ph (1,2)
                                vector<complex<double> >* dCouplings_mix12_45 = new vector<complex<double> >;
                                dCouplings_mix12_45->push_back(cos(angle)); //g1-term
                                dCouplings_mix12_45->push_back(sin(angle)); //g2-term
                                dCouplings_mix12_45->push_back(0);          //g3-term
                                dCouplings_mix12_45->push_back(0);          //g4-term
                                MEMsnoPDFs->computeME(kSpin0_gg, kJHUGen, P4s, tmpIDs, prod, dCouplings_mix12_45, ME_Xmix12_45);
                                // mixed 0Ph-0M (2,3)
                                vector<complex<double> >* dCouplings_mix23_45 = new vector<complex<double> >;
                                dCouplings_mix23_45->push_back(0);          //g1-term
                                dCouplings_mix23_45->push_back(cos(angle)); //g2-term
                                dCouplings_mix23_45->push_back(0);          //g3-term
                                dCouplings_mix23_45->push_back(sin(angle)); //g4-term
                                MEMsnoPDFs->computeME(kSpin0_gg, kJHUGen, P4s, tmpIDs, prod, dCouplings_mix23_45, ME_Xmix23_45);

                                angle = 60 * PI/180.;
                                // mixed H-0M (1,3)
                                vector<complex<double> >* dCouplings_mix13_60 = new vector<complex<double> >;
                                dCouplings_mix13_60->push_back(cos(angle)); //g1-term
                                dCouplings_mix13_60->push_back(0);          //g2-term
                                dCouplings_mix13_60->push_back(0);          //g3-term
                                dCouplings_mix13_60->push_back(sin(angle)); //g4-term
                                MEMsnoPDFs->computeME(kSpin0_gg, kJHUGen, P4s, tmpIDs, prod, dCouplings_mix13_60, ME_Xmix13_60);
                                // mixed H-0Ph (1,2)
                                vector<complex<double> >* dCouplings_mix12_60 = new vector<complex<double> >;
                                dCouplings_mix12_60->push_back(cos(angle)); //g1-term
                                dCouplings_mix12_60->push_back(sin(angle)); //g2-term
                                dCouplings_mix12_60->push_back(0);          //g3-term
                                dCouplings_mix12_60->push_back(0);          //g4-term
                                MEMsnoPDFs->computeME(kSpin0_gg, kJHUGen, P4s, tmpIDs, prod, dCouplings_mix12_60, ME_Xmix12_60);
                                // mixed 0Ph-0M (2,3)
                                vector<complex<double> >* dCouplings_mix23_60 = new vector<complex<double> >;
                                dCouplings_mix23_60->push_back(0);          //g1-term
                                dCouplings_mix23_60->push_back(cos(angle)); //g2-term
                                dCouplings_mix23_60->push_back(0);          //g3-term
                                dCouplings_mix23_60->push_back(sin(angle)); //g4-term
                                MEMsnoPDFs->computeME(kSpin0_gg, kJHUGen, P4s, tmpIDs, prod, dCouplings_mix23_60, ME_Xmix23_60);

                                ME_X13_int        = computeInterferenceTermKappas((*dCouplings_mix13_45)[0].real(), 0.,                               (*dCouplings_mix13_45)[3].real(), ME_H, 0,     ME_PS, ME_Xmix13_45);
                                ME_X12_int        = computeInterferenceTermKappas((*dCouplings_mix12_45)[0].real(), (*dCouplings_mix12_45)[1].real(), 0.,                               ME_H, ME_PH, 0,     ME_Xmix12_45);
                                ME_X23_int        = computeInterferenceTermKappas(0.,                               (*dCouplings_mix23_45)[1].real(), (*dCouplings_mix23_45)[3].real(), 0,    ME_PH, ME_PS, ME_Xmix23_45);

                                //           // -------TEST------- //
                                //           ME_X13_int_from60 = computeInterferenceTermKappas((*dCouplings_mix13_60)[0].real(), 0., (*dCouplings_mix13_60)[3].real(), ME_H, 0, ME_PS, ME_Xmix13_60);
                                //           cout << "ME_Xmix13_45: " << ME_Xmix13_45 << ", ME_H: " << ME_H << ", ME_PS: " << ME_PS  << ", ME_X13_int: " << ME_X13_int << endl;
                                //           cout << "ME_Xmix13_60: " << ME_Xmix13_60 << ", ME_X13_int_from60: " << ME_X13_int_from60 << endl;
                                //           // -------TEST------- //

                                //------------------------------------//
                                //     the end of ME computations     //
                                //------------------------------------//
                                */
                                ...
                                if(!doBlinding || isMC) 
                                {
                                    ...
                                    {
                                        //genAna.fillGenEvent(genParticles,Higgs,Zs,leptonsS1,leptonsS3,isFromH,isFromW);
                                        //setGENVariables(Higgs,Zs,leptonsS1,leptonsS3,isFromH,isFromW);
                                ...
                                if( Z2Vec.M() > 12 )
                                {
                                    ...
                                    //else {std::cout<<runId<<":"<<lumiId<<":"<<eventId<<" failed M4lCut"<<std::endl;}
                                }//Z2 > 12
                                //else {std::cout<<runId<<":"<<lumiId<<":"<<eventId<<" failed Z2>12"<<std::endl;}
                            } //fourLep_Cleaned
                            //else {std::cout<<runId<<":"<<lumiId<<":"<<eventId<<" failed fourLep_Cleaned"<<std::endl;}
                        }//passedPtCuts
                        //else {std::cout<<runId<<":"<<lumiId<<":"<<eventId<<" failed PtCuts"<<std::endl;}
                    }//if HC
                    //else {std::cout<<runId<<":"<<lumiId<<":"<<eventId<<" failed HC"<<std::endl;}
                } // if 4 properID
                //else {std::cout<<runId<<":"<<lumiId<<":"<<eventId<<" failed 4 properID"<<std::endl;}
            } //if 4ID
            //else {std::cout<<runId<<":"<<lumiId<<":"<<eventId<<" failed 4ID"<<std::endl;}
        }//if ID
        //else {std::cout<<runId<<":"<<lumiId<<":"<<eventId<<" failed ID"<<std::endl;}     
   }//notDuplicate
    //else {std::cout<<runId<<":"<<lumiId<<":"<<eventId<<" failed notDuplicate"<<std::endl;}
...
{     
    ...
    tree->Branch("MomMomID_L1",&MomMomID_L1,"MomMomID_L1/I");
    tree->Branch("MomMomID_L2",&MomMomID_L2,"MomMomID_L2/I");
    tree->Branch("MomMomID_L3",&MomMomID_L3,"MomMomID_L3/I");
    tree->Branch("MomMomID_L4",&MomMomID_L4,"MomMomID_L4/I");
    ...
    */
    ...
    tree->Branch("leptonIntWeight",&leptonIntWeight,"leptonIntWeight/D");
    ...
    tree->Branch("JHU_ME_H_prodIndep",&JHU_ME_H_prodIndep,"JHU_ME_H_prodIndep/D");
    tree->Branch("MCFM_ME_qqZZ",&MCFM_ME_qqZZ,"MCFM_ME_qqZZ/D");
    tree->Branch("MCFM_ME_qqZZ_prodIndep",&MCFM_ME_qqZZ_prodIndep,"MCFM_ME_qqZZ_prodIndep/D");
    tree->Branch("JHUKD_H_qqZZ_prodIndep_noPDF",&JHUKD_H_qqZZ_prodIndep_noPDF,"JHUKD_H_qqZZ_prodIndep_noPDF/D");
    ...
    tree->Branch("JHUKD_H_h2hP_prodInd_noPDF",&JHUKD_H_h2hP_prodInd_noPDF,"JHUKD_H_h2hP_prodInd_noPDF/D");
    tree->Branch("JHU_ME_h2hP_prodInd",&JHU_ME_h2hP_prodInd,"JHU_ME_h2hP_prodInd/D");
    tree->Branch("JHUKD_H_h2hM_prodInd_noPDF",&JHUKD_H_h2hM_prodInd_noPDF,"JHUKD_H_h2hM_prodInd_noPDF/D");
    tree->Branch("JHU_ME_h2hM_prodInd",&JHU_ME_h2hM_prodInd,"JHU_ME_h2hM_prodInd/D");
    tree->Branch("JHUKD_H_h2bP_prodInd_noPDF",&JHUKD_H_h2bP_prodInd_noPDF,"JHUKD_H_h2bP_prodInd_noPDF/D");
    tree->Branch("JHU_ME_h2bP_prodInd",&JHU_ME_h2bP_prodInd,"JHU_ME_h2bP_prodInd/D");
    tree->Branch("JHUKD_H_qqh2hP_noPDF",&JHUKD_H_qqh2hP_noPDF,"JHUKD_H_qqh2hP_noPDF/D");
    tree->Branch("JHU_ME_qqh2hP",&JHU_ME_qqh2hP,"JHU_ME_qqh2hP/D");
    tree->Branch("JHUKD_H_qqh2hM_noPDF",&JHUKD_H_qqh2hM_noPDF,"JHUKD_H_qqh2hM_noPDF/D");
    tree->Branch("JHU_ME_qqh2hM",&JHU_ME_qqh2hM,"JHU_ME_qqh2hM/D");
    tree->Branch("JHUKD_H_qqh2bP_noPDF",&JHUKD_H_qqh2bP_noPDF,"JHUKD_H_qqh2bP_noPDF/D");
    tree->Branch("JHU_ME_qqh2bP",&JHU_ME_qqh2bP,"JHU_ME_qqh2bP/D");

    tree->Branch("JHUKD_H_ggZZ_noPDF",&JHUKD_H_ggZZ_noPDF,"JHUKD_H_ggZZ_noPDF/D");
    tree->Branch("MCFM_ME_ggZZ",&MCFM_ME_ggZZ,"MCFM_ME_ggZZ/D");

    tree->Branch("JHUKD_H_h2h2P_prodInd_noPDF",&JHUKD_H_h2h2P_prodInd_noPDF,"JHUKD_H_h2h2P_prodInd_noPDF/D");
    tree->Branch("JHU_ME_h2h2P_prodInd",&JHU_ME_h2h2P_prodInd,"JHU_ME_h2h2P_prodInd/D");
    tree->Branch("JHUKD_H_h2h3P_prodInd_noPDF",&JHUKD_H_h2h3P_prodInd_noPDF,"JHUKD_H_h2h3P_prodInd_noPDF/D");
    tree->Branch("JHU_ME_h2h3P_prodInd",&JHU_ME_h2h3P_prodInd,"JHU_ME_h2h3P_prodInd/D");
    tree->Branch("JHUKD_H_h2h6P_prodInd_noPDF",&JHUKD_H_h2h6P_prodInd_noPDF,"JHUKD_H_h2h6P_prodInd_noPDF/D");
    tree->Branch("JHU_ME_h2h6P_prodInd",&JHU_ME_h2h6P_prodInd,"JHU_ME_h2h6P_prodInd/D");
    tree->Branch("JHUKD_H_h2h7P_prodInd_noPDF",&JHUKD_H_h2h7P_prodInd_noPDF,"JHUKD_H_h2h7P_prodInd_noPDF/D");
    tree->Branch("JHU_ME_h2h7P_prodInd",&JHU_ME_h2h7P_prodInd,"JHU_ME_h2h7P_prodInd/D");
    tree->Branch("JHUKD_H_h2h9M_prodInd_noPDF",&JHUKD_H_h2h9M_prodInd_noPDF,"JHUKD_H_h2h9M_prodInd_noPDF/D");
    tree->Branch("JHU_ME_h2h9M_prodInd",&JHU_ME_h2h9M_prodInd,"JHU_ME_h2h9M_prodInd/D");
    tree->Branch("JHUKD_H_h2h10M_prodInd_noPDF",&JHUKD_H_h2h10M_prodInd_noPDF,"JHUKD_H_h2h10M_prodInd_noPDF/D");
    tree->Branch("JHU_ME_h2h10M_prodInd",&JHU_ME_h2h10M_prodInd,"JHU_ME_h2h10M_prodInd/D");

    tree->Branch("JHUKD_H_ggh2h2P_noPDF",&JHUKD_H_ggh2h2P_noPDF,"JHUKD_H_ggh2h2P_noPDF/D");
    tree->Branch("JHU_ME_ggh2h2P",&JHU_ME_ggh2h2P,"JHU_ME_ggh2h2P/D");
    tree->Branch("JHUKD_H_ggh2h3P_noPDF",&JHUKD_H_ggh2h3P_noPDF,"JHUKD_H_ggh2h3P_noPDF/D");
    tree->Branch("JHU_ME_ggh2h3P",&JHU_ME_ggh2h3P,"JHU_ME_ggh2h3P/D");
    tree->Branch("JHUKD_H_ggh2h6P_noPDF",&JHUKD_H_ggh2h6P_noPDF,"JHUKD_H_ggh2h6P_noPDF/D");
    tree->Branch("JHU_ME_ggh2h6P",&JHU_ME_ggh2h6P,"JHU_ME_ggh2h6P/D");
    tree->Branch("JHUKD_H_ggh2h7P_noPDF",&JHUKD_H_ggh2h7P_noPDF,"JHUKD_H_ggh2h7P_noPDF/D");
    tree->Branch("JHU_ME_ggh2h7P",&JHU_ME_ggh2h7P,"JHU_ME_ggh2h7P/D");
    tree->Branch("JHUKD_H_ggh2h9M_noPDF",&JHUKD_H_ggh2h9M_noPDF,"JHUKD_H_ggh2h9M_noPDF/D");
    tree->Branch("JHU_ME_ggh2h9M",&JHU_ME_ggh2h9M,"JHU_ME_ggh2h9M/D");
    tree->Branch("JHUKD_H_ggh2h10M_noPDF",&JHUKD_H_ggh2h10M_noPDF,"JHUKD_H_ggh2h10M_noPDF/D");
    tree->Branch("JHU_ME_ggh2h10M",&JHU_ME_ggh2h10M,"JHU_ME_ggh2h10M/D");

    tree->Branch("JHUKD_H_qqh2h2P_noPDF",&JHUKD_H_qqh2h2P_noPDF,"JHUKD_H_qqh2h2P_noPDF/D");
    tree->Branch("JHU_ME_qqh2h2P",&JHU_ME_qqh2h2P,"JHU_ME_qqh2h2P/D");
    tree->Branch("JHUKD_H_qqh2h3P_noPDF",&JHUKD_H_qqh2h3P_noPDF,"JHUKD_H_qqh2h3P_noPDF/D");
    tree->Branch("JHU_ME_qqh2h3P",&JHU_ME_qqh2h3P,"JHU_ME_qqh2h3P/D");
    tree->Branch("JHUKD_H_qqh2h6P_noPDF",&JHUKD_H_qqh2h6P_noPDF,"JHUKD_H_qqh2h6P_noPDF/D");
    tree->Branch("JHU_ME_qqh2h6P",&JHU_ME_qqh2h6P,"JHU_ME_qqh2h6P/D");
    tree->Branch("JHUKD_H_qqh2h7P_noPDF",&JHUKD_H_qqh2h7P_noPDF,"JHUKD_H_qqh2h7P_noPDF/D");
    tree->Branch("JHU_ME_qqh2h7P",&JHU_ME_qqh2h7P,"JHU_ME_qqh2h7P/D");
    tree->Branch("JHUKD_H_qqh2h9M_noPDF",&JHUKD_H_qqh2h9M_noPDF,"JHUKD_H_qqh2h9M_noPDF/D");
    tree->Branch("JHU_ME_qqh2h9M",&JHU_ME_qqh2h9M,"JHU_ME_qqh2h9M/D");
    tree->Branch("JHUKD_H_qqh2h10M_noPDF",&JHUKD_H_qqh2h10M_noPDF,"JHUKD_H_qqh2h10M_noPDF/D");
    tree->Branch("JHU_ME_qqh2h10M",&JHU_ME_qqh2h10M,"JHU_ME_qqh2h10M/D");
    ...
    tree->Branch("MEKD_h2P_ZZ_noPDF_noFSR",&MEKD_h2P_ZZ_prodInd_noPDF_noFSR,"MEKD_h2P_ZZ_prodInd_noPDF_noFSR/D");
    ...
    tree->Branch("ME_ZZ",&MCFM_ME_qqZZ,"ME_ZZ/D");
    tree->Branch("ME_H",&ME_H,"ME_H/D");
    tree->Branch("ME_PS",&ME_PS,"ME_PS/D");
    tree->Branch("ME_PH",&ME_PH,"ME_PH/D");
    tree->Branch("ME_X13_int",&ME_X13_int,"ME_X13_int/D");
    tree->Branch("ME_X12_int",&ME_X12_int,"ME_X12_int/D");
    tree->Branch("ME_X23_int",&ME_X23_int,"ME_X23_int/D");
    tree->Branch("ME_X13_int_kg1g4",&ME_X13_int_kg1g4,"ME_X13_int_kg1g4/D");
    tree->Branch("ME_X12_int_kg1g2",&ME_X12_int_kg1g2,"ME_X12_int_kg1g2/D");
    tree->Branch("ME_X23_int_kg2g4",&ME_X23_int_kg2g4,"ME_X23_int_kg2g4/D");
    tree->Branch("ME_Xmix13_60",&ME_Xmix13_60,"ME_Xmix13_60/D");
    tree->Branch("ME_Xmix12_60",&ME_Xmix12_60,"ME_Xmix12_60/D");
    tree->Branch("ME_Xmix23_60",&ME_Xmix23_60,"ME_Xmix23_60/D");

    tree->Branch("GENidLS1",&GENidLS1);
    tree->Branch("GENchargeLS1",&GENchargeLS1);
    tree->Branch("GENisfromHLS1",&GENisfromHLS1);
    tree->Branch("GENmomIdLS1",&GENmomIdLS1);
    tree->Branch("GENisoLS1",&GENisoLS1);

    GENp4LS1 = new TClonesArray("TLorentzVector", 10);
    tree->Branch("GENp4LS1","TClonesArray", &GENp4LS1,128000, 0);

    tree->Branch("Z1daughtersId",&Z1daughtersId);
    tree->Branch("Z2daughtersId",&Z2daughtersId);
    tree->Branch("Z1momId",&Z1momId);
    tree->Branch("Z2momId",&Z2momId);
    tree->Branch("nGenZs",&nGenZs);
    tree->Branch("GENp4Z1",&GENp4Z1);
    tree->Branch("GENp4Z2",&GENp4Z2);

    tree->Branch("GENidLS3",&GENidLS3);
    tree->Branch("GENchargeLS3",&GENchargeLS3);
    tree->Branch("GENisfromHLS3",&GENisfromHLS3);
    tree->Branch("GENisfromWLS3",&GENisfromWLS3);
    tree->Branch("GENmomIdLS3",&GENmomIdLS3);
    tree->Branch("GENisoLS3",&GENisoLS3);
    tree->Branch("GENchargedisoLS3",&GENisoLS3);
    tree->Branch("GENneutralisoLS3",&GENisoLS3);

    GENp4LS3 = new TClonesArray("TLorentzVector", 10);
    tree->Branch("GENp4LS3","TClonesArray", &GENp4LS3,128000, 0);
    tree->Branch("GENmZ1Z2",&GENmZ1Z2);

    tree->Branch("GENlepIndex1", &GENlepIndex1);
    tree->Branch("GENlepIndex2", &GENlepIndex2);
    tree->Branch("GENlepIndex3", &GENlepIndex3);
    tree->Branch("GENlepIndex4", &GENlepIndex4);

    tree->Branch("GENrecoIso",&GENrecoIso);
    tree->Branch("GENrecoIsoCharged",&GENrecoIsoCharged);
    tree->Branch("GENrecoIsoNeutral",&GENrecoIsoNeutral);

    genJetP4 = new TClonesArray("TLorentzVector", 10);
    tree->Branch("genJetP4","TClonesArray", &genJetP4, 128000, 0);

    genJetP4_dR = new TClonesArray("TLorentzVector", 10);
    tree->Branch("genJetP4_dR","TClonesArray", &genJetP4_dR, 128000, 0);
    ...
    tree->Branch("passedFiducialKinematics",&passedFiducialKinematics, "passedFiducialKinematics/O");
    tree->Branch("passedFiducialTopology",&passedFiducialTopology, "passedFiducialTopology/O");
    ...
    selectedJetP4 = new TClonesArray("TLorentzVector", 20);
    tree->Branch("selectedJetP4","TClonesArray", &selectedJetP4, 128000, 0);
                                   ...
                                   std::vector<pat::Muon> selectedMuons, std::vector<pat::Electron> selectedElectrons, std::vector<pat::Jet> selectedVBFJets, std::vector<pat::Jet> correctedVBFJets)
{
    ...
    for( unsigned int k = 0; k < selectedVBFJets.size(); k++) {
        ...
        if (isDeltaR && correctedVBFJets[k].pt() > pt_cut && fabs(selectedVBFJets[k].eta()) < eta_cut) {
                finalVBFJets.push_back(correctedVBFJets[k]);
                new ( (*selectedJetP4)[k] ) TLorentzVector(correctedVBFJets[k].px(), correctedVBFJets[k].py(), correctedVBFJets[k].pz(), correctedVBFJets[k].energy());
        }
    }
                                 ...
                                 std::vector<reco::GenParticle> leptonsS1, std::vector<reco::GenParticle> leptonsS3, std::vector<bool> isFromH, std::vector<bool> isFromW)
{
    ...
    if( leptonsS1.size() >= 4) {
        ...
        GENp4LS1->Clear(); GENidLS1.clear(); GENchargeLS1.clear(); GENisoLS1.clear(); GENisfromHLS1.clear(); GENmomIdLS1.clear();           

        for (unsigned int i=0; i<leptonsS1.size(); ++i) {

            GENidLS1.push_back( leptonsS1[i].pdgId() );
            GENchargeLS1.push_back(leptonsS1[i].charge());
            GENmomIdLS1.push_back(genAna.MotherID(&leptonsS1[i]));

            new ( (*GENp4LS1)[i] ) TLorentzVector(leptonsS1[i].px(),leptonsS1[i].py(),leptonsS1[i].pz(),leptonsS1[i].energy());
        }        
    ...
    if( Zs.size() >= 2) {
        ...
        const reco::GenParticle Z1 = Zs[0];
        const reco::GenParticle Z2 = Zs[1];

        const reco::Candidate *Z1dau0=Z1.daughter(0);
        const reco::Candidate *Z2dau0=Z2.daughter(0);
        
        Z1daughtersId = fabs(Z1dau0->pdgId());
        Z2daughtersId = fabs(Z2dau0->pdgId());

        const reco::Candidate *Z1mom=Z1.mother(0);
        const reco::Candidate *Z2mom=Z2.mother(0);

        Z1momId = Z1mom->pdgId();
        Z2momId = Z2mom->pdgId();

        TLorentzVector genZ1(Zs[0].px(), Zs[0].py(), Zs[0].pz(), Zs[0].energy());
        TLorentzVector genZ2(Zs[1].px(), Zs[1].py(), Zs[1].pz(), Zs[1].energy());
    ...
    if( leptonsS3.size() >= 4) {
        ...
        std::sort(leptonsS3.begin(), leptonsS3.end(), sortByPt);

        /////// DO THE FIDUCIAL VOLUME CALCULATION //////////////
        int nFiducialLeptons = 0;
        
        GENp4LS3->Clear(); GENidLS3.clear(); GENchargeLS3.clear(); GENisoLS3.clear(); GENisfromHLS3.clear(); GENisfromWLS3.clear(); GENmomIdLS3.clear();

        passedFiducialKinematics=false;

        for (unsigned int i=0; i<leptonsS3.size(); ++i) {    
            
            double this_GENiso = 0.0; double this_GENneutraliso = 0.0; double this_GENchargediso = 0.0;
            
            if ( (abs(leptonsS3[i].pdgId()) == 13 && leptonsS3[i].pt() > 5.0 && abs(leptonsS3[i].eta()) < 2.4)
                 || (abs(leptonsS3[i].pdgId()) == 11 && leptonsS3[i].pt() > 7.0 && abs(leptonsS3[i].eta()) < 2.5) ) {
                ...
                for(genPart = genParticles->begin(); genPart != genParticles->end(); genPart++) {
                    ...
                    double this_dRvL = deltaR(leptonsS3[i].eta(), leptonsS3[i].phi(), genPart->eta(), genPart->phi());
                    
                    if(this_dRvL<0.4 && (abs(leptonsS3[i].pdgId())==11 || (abs(leptonsS3[i].pdgId())==13 && abs(genPart->charge())!=0) || (abs(leptonsS3[i].pdgId())==13 && abs(genPart->charge())==0 && genPart->pt()>0.5) ) ) { 
                        this_GENiso = this_GENiso + genPart->pt(); 
                        if (genPart->charge()==0) this_GENneutraliso = this_GENneutraliso + genPart->pt();
                        if (genPart->charge()!=0) this_GENchargediso = this_GENchargediso + genPart->pt();
                    }                                                                  
                }
                this_GENiso = this_GENiso/leptonsS3[i].pt();
                // end gen iso calculation

                if (this_GENiso<genIsoCut) {

                    nFiducialLeptons++;                        

                    new ( (*GENp4LS3)[nFiducialLeptons-1] ) TLorentzVector(leptonsS3[i].px(),leptonsS3[i].py(),leptonsS3[i].pz(),leptonsS3[i].energy());
                    GENidLS3.push_back(leptonsS3[i].pdgId()); 
                    GENchargeLS3.push_back(leptonsS3[i].charge()); 
                    GENisoLS3.push_back(this_GENiso);
                    GENisfromHLS3.push_back(genAna.IsMotherH(&leptonsS3[i]));
                    GENisfromWLS3.push_back(genAna.IsMotherW(&leptonsS3[i]));
                    GENmomIdLS3.push_back(genAna.MotherID(&leptonsS3[i]));

                } // passed isolation cut                     
            } // passed pt and eta cuts
        } // all status 3 e's and mu's

        if (nFiducialLeptons>=4) {


            TLorentzVector *LS3_1 = (TLorentzVector*) GENp4LS3->At(0);
            TLorentzVector *LS3_2 = (TLorentzVector*) GENp4LS3->At(1);
            
            if ( (*LS3_1).Pt()>leadingPtCut && (*LS3_2).Pt()>subleadingPtCut) {
                                
                passedFiducialKinematics=true;
                
                // START FIDUCIAL EVENT TOPOLOGY CUTS
                passedFiducialTopology=false;
                unsigned int L1=10; unsigned int L2=10; unsigned int L3=10; unsigned int L4=10;
                GENmZ1Z2 = 0;
                passedFiducialTopology = mZ1_mZ2(GENp4LS3, GENidLS3, L1, L2, L3, L4);      

                GENlepIndex1 = L1; GENlepIndex2 = L2; GENlepIndex3 = L3; GENlepIndex4 = L4;

                if (passedFiducialTopology) {

                    TLorentzVector *LS3_Z1_1 = (TLorentzVector*) GENp4LS3->At(L1);
                    TLorentzVector *LS3_Z1_2 = (TLorentzVector*) GENp4LS3->At(L2);
                    TLorentzVector *LS3_Z2_1 = (TLorentzVector*) GENp4LS3->At(L3);
                    TLorentzVector *LS3_Z2_2 = (TLorentzVector*) GENp4LS3->At(L4);
                    
                    GENmZ1Z2 = ((*LS3_Z1_1)+(*LS3_Z1_2)+(*LS3_Z2_1)+(*LS3_Z2_2)).M();
                }
                ...
                unsigned int N=(u_int)GENp4LS3->GetLast()+1;
                for(unsigned int i = 0; i<N; i++) {
                    for(unsigned int j = i+1; j<N; j++) {
                        ...
                        li = (TLorentzVector*) GENp4LS3->At(i);
                        lj = (TLorentzVector*) GENp4LS3->At(j);
                        TLorentzVector mll = (*li)+(*lj);
                        
                        if(GENidLS3[i]*GENidLS3[j]<0)
                        {
                            if(mll.M()<=4) { passedMassOS = false; break; }
                        }
                        
                        if(abs(GENidLS3[i]) != abs(GENidLS3[j]))
                        {
                ...
                if(passedMassOS==false || passedElMuDeltaR==false || passedDeltaR==false) passedFiducialTopology=false;
                
                // DO GEN JETS
                genJetP4->Clear(); genJetP4_dR->Clear();
                ...
                for(genjet = genJets->begin(); genjet != genJets->end(); genjet++) {
                    ...
                    j++;
                    new ( (*genJetP4)[j] ) TLorentzVector(genjet->px(), genjet->py(), genjet->pz(), genjet->energy());
                    
                    if(passedFiducialTopology){
                        bool inDR = false; unsigned int N_gen_S3 = leptonsS3.size();
                        for(unsigned int i = 0; i<N_gen_S3; i++){
                            if(!(i==L1 || i==L2 || i==L3 || i==L4)) continue;                       
                        ...
                        if(!inDR) { 
                            new ( (*genJetP4_dR)[j] ) TLorentzVector(genjet->px(), genjet->py(), genjet->pz(), genjet->energy());
                        }
                    }
                    else {  
                        new ( (*genJetP4_dR)[j] ) TLorentzVector(genjet->px(), genjet->py(), genjet->pz(), genjet->energy());
...
void UFHZZ4LAna::setGENMatchedVariables(std::vector<pat::Muon> selectedMuons, std::vector<pat::Electron> selectedElectrons, std::vector<reco::GenParticle> leptonsS1)
{
    ...
    for(unsigned int i = 0; i < selectedMuons.size(); i++)
    {
        ...
        //cout<<"muon #"<<i<<" pt: "<<selectedMuons[i].pt()<<" eta: "<<selectedMuons[i].eta()<<" N genParticleRefs: "<<selectedMuons[i].genParticleRefs().size()<<endl;
        ...
        if (selectedMuons[i].genParticleRefs().size()==0) {
            ...
            if (ref<999999) {
                ...
                mommomID=genAna.MotherMotherID(&leptonsS1.at(ref));
        ...
        for(unsigned int j = 0; j < selectedMuons[i].genParticleRefs().size(); j++)
        {
            ...
            mommomID=genAna.MotherMotherID(selectedMuons[i].genParticle(j));
        ...
        if(i == 0)
        {
            if(!RecoTwoETwoMuEvent)
            {
                ...
                isFromH_L1 = isFromH; MomID_L1 = momID; MomMomID_L1= mommomID;
                ...
                isFromH_L3 = isFromH; MomID_L3 = momID; MomMomID_L3 = mommomID;
        ...
        if(i == 1)
        {
            if(!RecoTwoETwoMuEvent)
            {
                ...
                isFromH_L2 = isFromH; MomID_L2 = momID; MomMomID_L2 = mommomID;
                ...
                isFromH_L4 = isFromH; MomID_L4 = momID; MomMomID_L4 = mommomID;
        ...
        if(i == 3)
        {
            ...
            isFromH_L4 = isFromH; MomID_L4 = momID; MomMomID_L4 = momID;
    ...
    for(unsigned int i = 0; i < selectedElectrons.size(); i++)
    {
        ...
        //cout<<"electron #"<<i<<" pt: "<<selectedElectrons[i].pt()<<" eta: "<<selectedElectrons[i].eta()<<" N genParticleRefs: "<<selectedElectrons[i].genParticleRefs().size()<<endl;
        ...
        for(unsigned int j = 0; j < selectedElectrons[i].genParticleRefs().size(); j++)
        {
            ...
            mommomID=genAna.MotherMotherID(selectedElectrons[i].genParticle(j));
    ...
    //cout<<"MomID_L1: "<<MomID_L1<<" MomID_L2: "<<MomID_L2<<" MomID_L3: "<<MomID_L3<<" MomID_L4: "<<MomID_L4<<endl;
    //cout<<"MomMomID_L1: "<<MomMomID_L1<<" MomMomID_L2: "<<MomMomID_L2<<" MomMomID_L3: "<<MomMomID_L3<<" MomMomID_L4: "<<MomMomID_L4<<endl;
    //cout<<"isFromH_L1: "<<isFromH_L1<<" isFromH_L2: "<<isFromH_L2<<" isFromH_L3: "<<isFromH_L3<<" isFromH_L4: "<<isFromH_L4<<endl;
...
bool UFHZZ4LAna::mZ1_mZ2(TClonesArray *v4L, vector<int> idL, unsigned int& L1, unsigned int& L2, unsigned int& L3, unsigned int& L4)
{
    ...
    for(unsigned int i=0; i<N; i++){
        for(unsigned int j=i+1; j<N; j++){
            ...
            TLorentzVector *li, *lj;
            li = (TLorentzVector*) v4L->At(i);
            lj = (TLorentzVector*) v4L->At(j);
            TLorentzVector mll = (*li)+(*lj);

            //cout<<i<<" "<<j<<" "<<mll.M()<<endl;
            if(abs(mll.M()-91.2)<offshell){
                double mZ1 = mll.M();
    ...
    l1 = (TLorentzVector*) v4L->At(L1);
    l2 = (TLorentzVector*) v4L->At(L2);

    TLorentzVector ml1l2 = (*l1)+(*l2);

    //cout<<"mZ1: "<<ml1l2.M()<<endl;
